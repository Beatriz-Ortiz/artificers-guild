...
export default function SendingStone({ activePanel, visitedPanels, introComplete }: Props) {
    ...
    const id = setInterval(() => {
      ...
      for (const trigger of TRIGGERS) {
        ...
        if (trigger.check(state)) {
          ...
          // Clear lastPanel after consuming a "after-X" trigger to avoid re-firing
